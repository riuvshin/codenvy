...
public class AwsEcrAuthResolverTest {
    ...
    private void setup() {
        ...
        when(awsInitialAuthConfig.getEcr()).thenReturn(AWS_ECR);
    ...
    public void shouldGetDynamicXRegistryAuth() {
        AuthConfig authConfig =
                awsEcrAuthResolver.getDynamicXRegistryAuth(AWS_ECR);
    ...
    public void shouldReturnNullWhenGetDynamicXRegistryAuthIfRegistryIsNull() {
        assertNull(awsEcrAuthResolver.getDynamicXRegistryAuth(null));
    }

    @Test
    public void shouldReturnNullWhenGetDynamicXRegistryAuthIfCredentialsForSpecifiedRegistryIsNotConfigured() {
        assertNull(awsEcrAuthResolver.getDynamicXRegistryAuth("my.registry.com"));
    }
    ...
    public void shouldReturnNullWhenGetDynamicXRegistryAuthIfCredentialsIsNotConfigured() {
        ...
        assertNull(awsEcrAuthResolver.getDynamicXRegistryAuth(AWS_ECR));
    }
    ...
    public void shouldGetDynamicXRegistryConfig() {
        ...
        Map<String, AuthConfig> authConfigsMap =
                awsEcrAuthResolver.getDynamicXRegistryConfig();

        verify(awsEcrAuthResolver, atLeastOnce()).getDynamicXRegistryAuth(anyString());
